...
//typedef std::this_thread::sleep_for delay
//typedef sleep_for delay
...
class MPU9250
{
  ...
  public:
    ...
    unsigned char I2CBus;     //I2C Bus for MPU9250
    int I2CFile;              //File holding i2c info for MPU9250
    int I2CAddress;           //Base address of I2C device MPU9250 i.e 0x68
    int error;
    ...
    float deltatt = 0.0f, sum = 0.0f;  // integration interval for both filter schemes
    std::clock_t deltat=0;
    std::clock_t lastUpdate = 0, firstUpdate =0 ; // used to calculate integration interval
    std::clock_t Now = 0;        // used to calculate integration interval
